...
\begin{figure}[htp]
    \centering
    \includegraphics[width=14cm]{Diag-2.pdf}
...
\item  constructs a Merkel tree on top of all committed values: $\mkgen(com_{\st 1,1},...,com_{\st d,h})\rightarrow g$. %Let $\mathtt{MT}^{\st g}$ be a Merkel tree with a root node $g^{\st I}$. 
