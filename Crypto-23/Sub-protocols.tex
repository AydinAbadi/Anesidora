...
\section{Subroutines Used in \withFai}\label{sec::subroutines}
In this section, we present three subroutines and a primitive that will be used in the instantiation of \p, i.e., \withFai. 
