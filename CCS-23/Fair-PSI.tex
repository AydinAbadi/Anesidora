...
\vspace{-2.5mm}
\subsection{Detailed Description of \fpsi.} Now, we explain how \fpsi exactly works (see Table \ref{table:notation-table} in Appendix \ref{sec::notation-table} for a description of the main notations used). 
