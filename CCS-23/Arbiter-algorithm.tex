...
\begin{center}
    \begin{tcolorbox}[enhanced,width=3.3in, height=98.2mm,right=.5mm,
...
\item\label{ZSPA-A::Auditor-computation}  {\textbf{Auditor computation.} $\mathtt{Audit}(m, \vv{{k}},  q, \bm\zeta, b, g)\rightarrow (L, \vv{{\mu}})$}. 
...
\begin{enumerate}[leftmargin=1.3mm]
%
\item runs the checks in the verification phase (i.e., Phase \ref{ZSPA:verify}) of \zspa for every $j$, i.e., $\mathtt{Verify}(k_{\st j}, g, q, m, auditor)\rightarrow (a_{\st j}, s)$.
